...
export class FarmerComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceFarmer.updateParticipant(form.get('personID').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.caste) {
        formObject.caste = result.caste;
      } else {
        formObject.caste = null;
      }

      if (result.religion) {
        formObject.religion = result.religion;
      } else {
        formObject.religion = null;
      }

      if (result.occupation) {
        formObject.occupation = result.occupation;
      } else {
        formObject.occupation = null;
      }
